...
window.DASHWELL_CATALOG = [
...

  {
    ...
    meta: { platform: "macOS" },
    shots: [
      { src: "shots/dashcsv/dashcsv-dashboard-mac.png",
      ...
      { src: "shots/dashcsv/dashcsv-positions-mac.png",
...

  {
    ...
    meta: { platform: "macOS" },
    shots: [
      { src: "shots/formatstand/formatstand-convert-folder-mac.png",
        alt: "FormatStand on Mac converting a whole folder of audio files at once",
        caption: "Convert a whole folder", w: 640, h: 400 },
      { src: "shots/formatstand/formatstand-rename-from-tags-mac.png",
      ...
      { src: "shots/formatstand/formatstand-originals-safe-mac.png",
      ...
      { src: "shots/formatstand/formatstand-built-in-guide-mac.png",
